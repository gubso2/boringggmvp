  ...
  return (
    <section id="about" className="scroll-mt-24">
      <div className="mx-auto max-w-3xl px-6 py-24 sm:py-32">
        ...
        <h2 className="mt-4 font-display text-3xl font-semibold leading-[1.15] tracking-tight text-ink-950 sm:text-4xl">
        ...
        <p className="mt-4 text-[17px] leading-relaxed text-ink-600">
          ...
          drop names them, lists who they&rsquo;ve made for, and shows what it
